...
import com.weltevree.ego.model.IGoEventListener;
...
public class GamesViewContentProvider implements IStructuredContentProvider,
		IGoEventListener {
	...
	public Object[] getElements(Object parent) {
		if (goServer != null)
			return goServer.getGames().values().toArray();
		return new String[] {};
	}
